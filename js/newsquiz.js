...
(function($) {
	...
	var right_answers = 0;
		...
		if (right_answers <= 2){
		    $("#quiz_reply").html("Try brushing up on your ocean zone knowledge! You'll get 'em next time.");
		
		}
		
		if (right_answers >= 3){
		    $("#quiz_reply").html("Great job! You're nearly a ocean zone expert!");
		
		}
		
		if (right_answers >= 5){
		    $("#quiz_reply").html("Awesome! You are an ocean zone expert!");
